...
* 启动脚本  
  `wget --no-check-certificate -O gost.sh https://git.1999111.xyz/https://raw.githubusercontent.com/leleji/Multi-EasyGost/master/gost.sh && chmod +x gost.sh && ./gost.sh`  
